...
<div id="layoutSidenav_content">
                            ...
                            <tr>
                                ...
                                <td width="15%" class="text-center">
                                    <button type="button" class="btn btn-success btn-sm" data-bs-toggle="modal"
                                        data-bs-target="#ubahModal<?= $akun->userid; ?>"><i class="fas fa-edit"></i>
                                        Ubah</button>
                                    <button type="button" class="btn btn-danger btn-sm"
                                        onclick="hapus(<?= $akun->userid; ?>)"><i class="fas fa-trash-alt"></i>
                                        Hapus</button>
                                </td>
                            </tr>
                            <?php endforeach; ?>
    ...
    <!-- Modal Ubah -->
    <div class="modal fade" id="ubahModal<?= $k->userid; ?>" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
                            ...
                            <div class="col-md-12">
                                <div class="form-floating mb-3 mb-md-0">
                                    <input class="form-control" id="nama_lengkap" type="text" name="nama_lengkap"
                                        placeholder="Nama Lengkap" value="<?= $k->nama_lengkap; ?>" required />
                            ...
                            <div class="col-md-12">
                                <div class="form-floating mb-3 mb-md-0">
                                    <input
                                        ...
                                        placeholder="<?= lang('Auth.email') ?>" value="<?= $k->email; ?>" required />
                            ...
                            <div class="col-md-6">
                                <div class="form-floating mb-3 mb-md-0">
                                    <input
                                        ...
                                        placeholder="<?= lang('Auth.username') ?>" value="<?= $k->username; ?>"
                                        required />
                            ...
                            <div class="col-md-6">
                                <div class="form-floating mb-3 mb-md-0">
                                    <select class="form-select" aria-label="Default select example" id="group_id"
                                        ...
                                        <option value="<?= $l->id; ?>"
                                            <?php if ($l->id == $k->roleid) : ?>selected<?php endif ?>>
                                            <?= $l->id; ?>. <?= $l->name; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                        ...
                        <div class="col-md-6">
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input" name="password_hash"
                                        id="password_hash" value="checkedValue">
                                    Reset Password?
                                </label>
                            </div>
                        </div>
