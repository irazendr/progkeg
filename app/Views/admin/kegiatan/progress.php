...
<div id="layoutSidenav_content">
                                    ...
                                    <tr>
                                        ...
                                        <td width="15%" class="text-center">
                                            <button type="button" class="btn btn-success btn-sm" data-bs-toggle="modal"
                                                data-bs-target="#ubahModal<?= $k->prog_id; ?>"><i
                                                    class="fas fa-edit"></i>
                                                Update</button>
                                            <?php if (in_groups('Admin')) : ?>
                                            <button type="button" class="btn btn-danger btn-sm"
                                                onclick="hapus(<?= $k->prog_id; ?>)"><i class="fas fa-trash-alt"></i>
                                                Hapus</button>
                                            <?php endif; ?>
                                        </td>
                                    </tr>
                    ...
                    <form action="<?= base_url('input-progress/tambah'); ?>" method="post">
                        ...
                        <div class="mb-3">
                            <div class="form-floating mb-3 mb-md-0">
                                <select class="form-select" aria-label="Default select example" id="kode_kegiatan"
                                    name="kode_kegiatan">
    ...
    <!-- Modal Update -->
    <div class="modal fade" id="ubahModal<?= $l->prog_id; ?>" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header bg-modal text-white">
                ...
                <div class="modal-body">
                    <form action="<?= base_url('input-progress/ubah/' . $l->prog_id); ?>" method="post">
                        ...
                        <div class="mb-3">
                            <div class="form-floating mb-3 mb-md-0">
                                <select class="form-select" aria-label="Default select example" id="kode_kegiatan"
                                    name="kode_kegiatan" disabled>
                                    <?php foreach ($list_keg as $m) : ?>
                                    <option value="<?= $m->id_k; ?>"
                                        <?php if ($m->id_k == $l->id_keg) : ?>selected<?php endif ?>>
