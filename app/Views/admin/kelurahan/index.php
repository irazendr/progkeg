                            ...
                            <?php foreach ($data_kelurahan as $kel) : ?>
                                <tr>
                                    ...
                                    <td width="15%" class="text-center">
                                        <button type="button" class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#ubahModal<?= $kel->kode_kelurahan; ?>"><i class="fas fa-edit"></i>
                                        </button>
                                        <button type="button" class="btn btn-danger btn-sm" onclick="hapus(<?= $kel->kode_kelurahan; ?>)"><i class="fas fa-trash-alt"></i>
                                        </button>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                ...
                <div class="modal-body">
                    <form action="<?= base_url('kecamatan/tambah'); ?>" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="kode_kelurahan" id="kode_kelurahan" class="form-control <?php if (isset($validation) && $validation->getError('kode_kelurahan')) : ?>is-invalid<?php endif ?>" required>
